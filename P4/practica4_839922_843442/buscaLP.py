...
Fichero: busca.py
        Implementa un algoritmo de búsqueda basado en programación lineal. Resuelven el problema de 
...
def solve_LP(block) -> Solution:
    ...
    return Solution(selected_articles, W * H)
...
if __name__ == "__main__":
    ...
    with open(sys.argv[2], "w") as f:
        for solution in solutions:
            ...
            remaining_area = solution.total_area - area
            f.write("{} {:.6f}\n".format(remaining_area, solution.time))
